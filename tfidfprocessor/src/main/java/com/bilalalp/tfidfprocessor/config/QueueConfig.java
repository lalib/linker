...
import com.bilalalp.tfidfprocessor.service.TfIdfProcessorService;
...
@ComponentScan(value = {"com.bilalalp.tfidfprocessor"})
...
public class QueueConfig {
    ...
    @Autowired
    private TfIdfProcessorService tfIdfProcessorService;
    ...
    @Bean
    public MessageListenerContainer tfIdfProcessorQueueContainer() {
        ...
        simpleMessageListenerContainer.setMessageListener(tfIdfProcessorService);
