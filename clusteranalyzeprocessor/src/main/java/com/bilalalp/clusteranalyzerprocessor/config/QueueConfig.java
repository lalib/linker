package com.bilalalp.clusteranalyzerprocessor.config;

import com.bilalalp.clusteranalyzerprocessor.service.AnalyzeProcessorConsumer;
...
@ComponentScan(value = {"com.bilalalp.clusteranalyzerprocessor"})
...
public class QueueConfig {
    ...
    @Autowired
    private AnalyzeProcessorConsumer analyzeInitializerConsumer;
