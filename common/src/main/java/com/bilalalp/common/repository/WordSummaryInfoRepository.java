...
@Repository
public interface WordSummaryInfoRepository extends JpaRepository<WordSummaryInfo, Long> {
    ...
    @Query("SELECT p FROM WordSummaryInfo p WHERE p.linkSearchRequestInfo = :linkSearchRequestInfo AND p.id = :wordInfoId")
